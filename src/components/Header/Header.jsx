        ...
        <div className="container">
            <div className="header__content text__center text__light flex flex__center">
                ...
                <div className="header__content--right">
                    <h1 className="header__title fw__6">Weal -The Health Tech Club</h1>
                    <p className="para__text">WEAL, the health-tech club that empowers students to take control of their health, become Agents of Change, and spread healthy habits throughout their communities.</p>
